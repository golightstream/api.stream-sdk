...
const (
	RateLimiterType_RATE_LIMITER_TYPE_UNSPECIFIED RateLimiterType = 0
	RateLimiterType_RATE_LIMITER_TYPE_ACCOUNT_ID  RateLimiterType = 1
	RateLimiterType_RATE_LIMITER_TYPE_USER_ID     RateLimiterType = 2
	RateLimiterType_RATE_LIMITER_TYPE_PROJECT_ID  RateLimiterType = 3
)

// Enum value maps for RateLimiterType.
var (
	RateLimiterType_name = map[int32]string{
		0: "RATE_LIMITER_TYPE_UNSPECIFIED",
		1: "RATE_LIMITER_TYPE_ACCOUNT_ID",
		2: "RATE_LIMITER_TYPE_USER_ID",
		3: "RATE_LIMITER_TYPE_PROJECT_ID",
	}
	RateLimiterType_value = map[string]int32{
		"RATE_LIMITER_TYPE_UNSPECIFIED": 0,
		"RATE_LIMITER_TYPE_ACCOUNT_ID":  1,
		"RATE_LIMITER_TYPE_USER_ID":     2,
		"RATE_LIMITER_TYPE_PROJECT_ID":  3,
	}
)
...
type RateLimiterBucket int32

const (
	RateLimiterBucket_RATE_LIMITER_BUCKET_UNSPECIFIED       RateLimiterBucket = 0
	RateLimiterBucket_RATE_LIMITER_BUCKET_READ_WRITE        RateLimiterBucket = 1 // general read/write
	RateLimiterBucket_RATE_LIMITER_BUCKET_BROADCAST_CONTROL RateLimiterBucket = 2 // endpoints managing broadcast state
	RateLimiterBucket_RATE_LIMITER_BUCKET_ENGINE            RateLimiterBucket = 3 // endpoints called by engine
)

// Enum value maps for RateLimiterBucket.
var (
	RateLimiterBucket_name = map[int32]string{
		0: "RATE_LIMITER_BUCKET_UNSPECIFIED",
		1: "RATE_LIMITER_BUCKET_READ_WRITE",
		2: "RATE_LIMITER_BUCKET_BROADCAST_CONTROL",
		3: "RATE_LIMITER_BUCKET_ENGINE",
	}
	RateLimiterBucket_value = map[string]int32{
		"RATE_LIMITER_BUCKET_UNSPECIFIED":       0,
		"RATE_LIMITER_BUCKET_READ_WRITE":        1,
		"RATE_LIMITER_BUCKET_BROADCAST_CONTROL": 2,
		"RATE_LIMITER_BUCKET_ENGINE":            3,
	}
)

func (x RateLimiterBucket) Enum() *RateLimiterBucket {
	p := new(RateLimiterBucket)
	*p = x
	return p
}

func (x RateLimiterBucket) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RateLimiterBucket) Descriptor() protoreflect.EnumDescriptor {
	return file_live_v21_api_proto_enumTypes[1].Descriptor()
}

func (RateLimiterBucket) Type() protoreflect.EnumType {
	return &file_live_v21_api_proto_enumTypes[1]
}

func (x RateLimiterBucket) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RateLimiterBucket.Descriptor instead.
func (RateLimiterBucket) EnumDescriptor() ([]byte, []int) {
...
func (EventSubType) Descriptor() protoreflect.EnumDescriptor {
	return file_live_v21_api_proto_enumTypes[20].Descriptor()
}

func (EventSubType) Type() protoreflect.EnumType {
	return &file_live_v21_api_proto_enumTypes[20]
}
...
func (EventType) Descriptor() protoreflect.EnumDescriptor {
	return file_live_v21_api_proto_enumTypes[21].Descriptor()
}

func (EventType) Type() protoreflect.EnumType {
	return &file_live_v21_api_proto_enumTypes[21]
}
...
type RateLimiter struct {
	...
	Target RateLimiterType   `protobuf:"varint,1,opt,name=target,proto3,enum=live.v21.RateLimiterType" json:"target,omitempty"`
	Bucket RateLimiterBucket `protobuf:"varint,2,opt,name=bucket,proto3,enum=live.v21.RateLimiterBucket" json:"bucket,omitempty"`
}
...
func (x *RateLimiter) GetTarget() RateLimiterType {
	if x != nil {
		return x.Target
	}
	return RateLimiterType_RATE_LIMITER_TYPE_UNSPECIFIED
}

func (x *RateLimiter) GetBucket() RateLimiterBucket {
	if x != nil {
		return x.Bucket
	}
	return RateLimiterBucket_RATE_LIMITER_BUCKET_UNSPECIFIED
}
...
type RateLimitConfig struct {
	...
	Limits []*RateLimiter `protobuf:"bytes,1,rep,name=limits,proto3" json:"limits,omitempty"`
}
...
func (x *RateLimitConfig) GetLimits() []*RateLimiter {
	if x != nil {
		return x.Limits
	}
	return nil
...
type CreateWebRtcAccessTokenRequest struct {
	...
	ParticipantMetadata *structpb.Value `protobuf:"bytes,4,opt,name=participant_metadata,json=participantMetadata,proto3" json:"participant_metadata,omitempty"`
}
...
func (x *CreateWebRtcAccessTokenRequest) GetParticipantMetadata() *structpb.Value {
	if x != nil {
...
type SourceStateEvent struct {
	...
	RemoteAddress *string `protobuf:"bytes,5,opt,name=remote_address,json=remoteAddress,proto3,oneof" json:"remote_address,omitempty"`
	// what changed
	//
	// Types that are assignable to Type:
	//
...
func (x *SourceStateEvent) GetRemoteAddress() string {
...
func (x *Service) Reset() {
	*x = Service{}
	if protoimpl.UnsafeEnabled {
		mi := &file_live_v21_api_proto_msgTypes[168]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Service) Descriptor() ([]byte, []int) {
	return file_live_v21_api_proto_rawDescGZIP(), []int{168}
}
...
func (x *GetServiceResponse) Reset() {
	*x = GetServiceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_live_v21_api_proto_msgTypes[169]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetServiceResponse) Descriptor() ([]byte, []int) {
	return file_live_v21_api_proto_rawDescGZIP(), []int{169}
}
...
var file_live_v21_api_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MethodOptions)(nil),
		ExtensionType: ([]*RateLimitConfig)(nil),
		Field:         9000,
		Name:          "live.v21.rate_limit",
		Tag:           "bytes,9000,rep,name=rate_limit",
		Filename:      "live/v21/api.proto",
	},
}

// Extension fields to descriptorpb.MethodOptions.
var (
	// repeated live.v21.RateLimitConfig rate_limit = 9000;
	E_RateLimit = &file_live_v21_api_proto_extTypes[0]
)
...
var file_live_v21_api_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x1f, 0x0a, 0x1d, 0x42, 0x72, 0x6f, 0x61, 0x64,
	0x63, 0x61, 0x73, 0x74, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xde, 0x04, 0x0a, 0x0e, 0x57, 0x65, 0x62,
	0x68, 0x6f, 0x6f, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75,
	...
	,
	...
	0x00, 0x52, 0x1a, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x4f, 0x72, 0x69, 0x67,
	0x69, 0x6e, 0x41, 0x70, 0x69, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x72, 0x0a,
	0x20, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x5f, 0x6f, 0x72, 0x69, 0x67, 0x69,
	0x6e, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76,
	...
	,
	...
	,
	...
	0x62, 0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0xe0, 0x41, 0x05, 0xe0, 0x41, 0x03,
	0x82, 0xb5, 0x18, 0x02, 0x50, 0x01, 0x48, 0x01, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x88, 0x01, 0x01,
	0x12, 0x6e, 0x0a, 0x03, 0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x57, 0x92,
	0x41, 0x4e, 0x4a, 0x4c, 0x22, 0x72, 0x74, 0x6d, 0x70, 0x3a, 0x5c, 0x2f, 0x5c, 0x2f, 0x69, 0x6e,
	0x67, 0x65, 0x73, 0x74, 0x2e, 0x67, 0x6f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x73, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x32, 0x2f, 0x37, 0x31, 0x33, 0x32,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x88, 0x01, 0x01, 0x12, 0x39, 0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x11, 0x92, 0x41, 0x0b, 0x4a,
	0x09, 0x22, 0x43, 0x61, 0x6d, 0x65, 0x72, 0x61, 0x31, 0x22, 0xe0, 0x41, 0x02, 0x48, 0x01, 0x52,
	0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12,
	0x5c, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x30, 0x92, 0x41, 0x27, 0x4a, 0x25, 0x22, 0x37,
	...
	,
	...
	,
	...
	,
	...
	0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0xe0, 0x41, 0x05, 0xe0, 0x41, 0x03, 0x48, 0x00, 0x52,
	0x0d, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e, 0x74, 0x49, 0x64, 0x88, 0x01,
	0x01, 0x42, 0x11, 0x0a, 0x0f, 0x5f, 0x70, 0x61, 0x72, 0x74, 0x69, 0x63, 0x69, 0x70, 0x61, 0x6e,
	0x74, 0x5f, 0x69, 0x64, 0x22, 0x43, 0x0a, 0x07, 0x4c, 0x61, 0x74, 0x4c, 0x6f, 0x6e, 0x67, 0x12,
	...
	,
	...
	0x2d, 0x34, 0x62, 0x62, 0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0x52, 0x0c, 0x63,
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x0a, 0x70,
	...
	,
	...
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x50, 0x0a, 0x09, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x33, 0x92,
	0x41, 0x27, 0x4a, 0x25, 0x22, 0x37, 0x31, 0x33, 0x32, 0x62, 0x30, 0x30, 0x34, 0x2d, 0x36, 0x31,
	0x65, 0x38, 0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d, 0x38, 0x64, 0x63, 0x38, 0x2d, 0x34, 0x62, 0x62,
	0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0xe0, 0x41, 0x05, 0x82, 0xb5, 0x18, 0x02,
	0x10, 0x01, 0x52, 0x08, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x5c, 0x0a, 0x08,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x69, 0x76, 0x65,
	0x2e, 0x76, 0x32, 0x31, 0x2e, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x0a, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa9, 0x02, 0x0a, 0x17,
	...
	,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x50, 0x0a, 0x18, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa5, 0x01, 0x0a, 0x17, 0x44, 0x65,
	...
	,
	...
	0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e,
	0x76, 0x32, 0x31, 0x2e, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b,
	0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x85, 0x05, 0x0a, 0x14,
	...
	,
	...
	0x63, 0x74, 0x49, 0x64, 0x12, 0x77, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x6d,
	0x61, 0x73, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x46, 0x69, 0x65, 0x6c,
	0x64, 0x4d, 0x61, 0x73, 0x6b, 0x42, 0x3a, 0x92, 0x41, 0x34, 0x4a, 0x32, 0x22, 0x6d, 0x65, 0x74,
	0x61, 0x64, 0x61, 0x74, 0x61, 0x2c, 0x20, 0x6d, 0x61, 0x78, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x2c, 0x20, 0x72, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x69,
	0x64, 0x65, 0x6f, 0x2e, 0x66, 0x72, 0x61, 0x6d, 0x65, 0x52, 0x61, 0x74, 0x65, 0x22, 0xe0, 0x41,
	...
	,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31,
	0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x12, 0x36, 0x0a, 0x11, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x5f, 0x75,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x42, 0x09, 0x92, 0x41,
	0x06, 0x4a, 0x04, 0x74, 0x72, 0x75, 0x65, 0x52, 0x10, 0x62, 0x72, 0x6f, 0x61, 0x64, 0x63, 0x61,
	0x73, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x22, 0xf0, 0x01, 0x0a, 0x14, 0x44, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0xb2, 0x02, 0x0a, 0x22, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x42, 0x72,
	0x6f, 0x61, 0x64, 0x63, 0x61, 0x73, 0x74, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52,
	...
	,
	...
	,
	...
	0x64, 0x22, 0x1c, 0x0a, 0x1a, 0x53, 0x74, 0x61, 0x72, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x57, 0x65, 0x62, 0x52, 0x74, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0xbc, 0x01, 0x0a, 0x18, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x57,
	...
	0x62, 0x30, 0x30, 0x34, 0x2d, 0x36, 0x31, 0x65, 0x38, 0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d, 0x38,
	0x64, 0x63, 0x38, 0x2d, 0x34, 0x62, 0x62, 0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22,
	0xe0, 0x41, 0x02, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x22, 0x1b,
	0x0a, 0x19, 0x53, 0x74, 0x6f, 0x70, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x57, 0x65, 0x62,
	0x52, 0x74, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xb6, 0x04, 0x0a, 0x18,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x52, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c,
	...
	0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x5c, 0x0a, 0x08, 0x6d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x67,
	...
	,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32,
	0x31, 0x2e, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x64,
	0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x8f, 0x02, 0x0a, 0x15, 0x47,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x63, 0x74, 0x49, 0x64, 0x73, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x22, 0xcd, 0x02,
	0x0a, 0x19, 0x41, 0x64, 0x64, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x6f, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x52, 0x0a, 0x0d, 0x63,
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x36, 0x31, 0x65, 0x38, 0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d, 0x38, 0x64, 0x63, 0x38, 0x2d, 0x34,
	0x62, 0x62, 0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0xe0, 0x41, 0x02, 0x52, 0x08,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x26, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x88, 0x01, 0x01, 0x12, 0x3a, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e,
	0x52, 0x6f, 0x6c, 0x65, 0x42, 0x11, 0x92, 0x41, 0x0e, 0x4a, 0x0c, 0x22, 0x52, 0x4f, 0x4c, 0x45,
	0x5f, 0x4f, 0x57, 0x4e, 0x45, 0x52, 0x22, 0x48, 0x01, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x88,
	0x01, 0x01, 0x12, 0x41, 0x0a, 0x0c, 0x6d, 0x61, 0x78, 0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69,
	...
	0x30, 0x30, 0x30, 0x48, 0x02, 0x52, 0x0b, 0x6d, 0x61, 0x78, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61,
	0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x72, 0x6f, 0x6c, 0x65, 0x42,
	0x0f, 0x0a, 0x0d, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x22, 0x6a, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73,
	...
	,
	...
	,
	...
	0x32, 0x62, 0x30, 0x30, 0x34, 0x2d, 0x36, 0x31, 0x65, 0x38, 0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d,
	0x38, 0x64, 0x63, 0x38, 0x2d, 0x34, 0x62, 0x62, 0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66,
	0x22, 0xe0, 0x41, 0x02, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12,
	0x39, 0x0a, 0x0c, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x16, 0x92, 0x41, 0x10, 0x4a, 0x0e, 0x22, 0x45, 0x64, 0x64,
	0x79, 0x20, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x22, 0xe0, 0x41, 0x02, 0x52, 0x0b, 0x64,
	0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x49, 0x0a, 0x14, 0x70, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xc9, 0x02, 0x0a, 0x16, 0x44, 0x65,
	0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x52, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2d, 0x92, 0x41, 0x27,
	0x4a, 0x25, 0x22, 0x37, 0x31, 0x33, 0x32, 0x62, 0x30, 0x30, 0x34, 0x2d, 0x36, 0x31, 0x65, 0x38,
	0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d, 0x38, 0x64, 0x63, 0x38, 0x2d, 0x34, 0x62, 0x62, 0x33, 0x32,
	0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0xe0, 0x41, 0x02, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c,
	...
	0x31, 0x65, 0x38, 0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d, 0x38, 0x64, 0x63, 0x38, 0x2d, 0x34, 0x62,
	0x62, 0x33, 0x32, 0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0xe0, 0x41, 0x02, 0x52, 0x0d, 0x64,
	0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x37, 0x0a, 0x0b,
	0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x15, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x44, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x90, 0x02, 0x0a, 0x16, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x49, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2a, 0x92, 0x41, 0x27,
	0x4a, 0x25, 0x22, 0x37, 0x31, 0x33, 0x32, 0x62, 0x30, 0x30, 0x34, 0x2d, 0x36, 0x31, 0x65, 0x38,
	0x2d, 0x34, 0x39, 0x63, 0x31, 0x2d, 0x38, 0x64, 0x63, 0x38, 0x2d, 0x34, 0x62, 0x62, 0x33, 0x32,
	0x36, 0x39, 0x63, 0x65, 0x36, 0x66, 0x22, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x9b, 0x01, 0x0a, 0x0e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x41, 0x64, 0x64, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x63, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x6f, 0x75,
	...
	0x63, 0x74, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x04,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x15, 0x0a, 0x11, 0x57, 0x45,
	0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x48, 0x4f, 0x4f, 0x4b, 0x10,
	0x01, 0x12, 0x16, 0x0a, 0x12, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x45, 0x56, 0x45, 0x4e, 0x54, 0x10, 0x02, 0x2a, 0x99, 0x01, 0x0a, 0x0e, 0x57, 0x65,
	0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x53, 0x75, 0x62, 0x74, 0x79, 0x70, 0x65, 0x12, 0x1f, 0x0a, 0x1b,
	...
	0x1f, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x53, 0x55, 0x42, 0x54, 0x59, 0x50, 0x45,
	0x5f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x42, 0x52, 0x4f, 0x41, 0x44, 0x43, 0x41, 0x53, 0x54,
	0x10, 0x01, 0x12, 0x20, 0x0a, 0x1c, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f, 0x53, 0x55,
	0x42, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x57, 0x45, 0x42, 0x52,
	0x54, 0x43, 0x10, 0x02, 0x12, 0x1f, 0x0a, 0x1b, 0x57, 0x45, 0x42, 0x48, 0x4f, 0x4f, 0x4b, 0x5f,
	0x53, 0x55, 0x42, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4a, 0x4f, 0x49, 0x4e, 0x5f, 0x57, 0x45, 0x42,
	0x52, 0x54, 0x43, 0x10, 0x03, 0x2a, 0x42, 0x0a, 0x0b, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x46, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x1b, 0x2f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x7b, 0x63, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x7e, 0x0a, 0x10,
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x21, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	0x74, 0x65, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x44,
	...
	0x1b, 0x2f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x7b, 0x63, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x7d, 0x32, 0xa3, 0x0d, 0x0a,
	...
	0x74, 0x12, 0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x1f, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x43, 0x72, 0x65,
	...
	0x63, 0x74, 0x12, 0x81, 0x01, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x12, 0x1b, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x47, 0x65, 0x74,
	0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c,
	0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x38, 0x82, 0xd3,
	0xe4, 0x93, 0x02, 0x32, 0x12, 0x30, 0x2f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x7d, 0x32, 0xd4, 0x0a,
	0x0a, 0x0d, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x7c, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12,
	0x1d, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2d,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x27, 0x3a, 0x01, 0x2a, 0x22, 0x22, 0x2f, 0x63, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x7b, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x7d, 0x2f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x85, 0x01,
	0x0a, 0x0c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x1d,
	0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x30, 0x2a, 0x2e, 0x2f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69,
	...
	0x65, 0x5f, 0x69, 0x64, 0x7d, 0x12, 0x88, 0x01, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x1d, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32,
	0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x6c, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x32, 0x31,
	...
	,
	...
	,
	...
	,
}
...
var file_live_v21_api_proto_enumTypes = make([]protoimpl.EnumInfo, 22)
var file_live_v21_api_proto_msgTypes = make([]protoimpl.MessageInfo, 171)
var file_live_v21_api_proto_goTypes = []interface{}{
	(RateLimiterType)(0),                        // 0: live.v21.RateLimiterType
	(RateLimiterBucket)(0),                      // 1: live.v21.RateLimiterBucket
	(BroadcastOrigin)(0),                        // 2: live.v21.BroadcastOrigin
	(WebhookType)(0),                            // 3: live.v21.WebhookType
	(WebhookSubtype)(0),                         // 4: live.v21.WebhookSubtype
	(ImageFormat)(0),                            // 5: live.v21.ImageFormat
	(VideoColorSpace)(0),                        // 6: live.v21.VideoColorSpace
	(AudioChannelLayout)(0),                     // 7: live.v21.AudioChannelLayout
	(RenderingQuality)(0),                       // 8: live.v21.RenderingQuality
	(VideoCodec)(0),                             // 9: live.v21.VideoCodec
	(VideoCodecProfile)(0),                      // 10: live.v21.VideoCodecProfile
	(AudioCodec)(0),                             // 11: live.v21.AudioCodec
	(VideoCodecRateControlMode)(0),              // 12: live.v21.VideoCodecRateControlMode
	(ProjectBroadcastPhase)(0),                  // 13: live.v21.ProjectBroadcastPhase
	(S3ACL)(0),                                  // 14: live.v21.S3ACL
	(SourceTriggerAction)(0),                    // 15: live.v21.SourceTriggerAction
	(Region)(0),                                 // 16: live.v21.Region
	(Role)(0),                                   // 17: live.v21.Role
	(ProjectBroadcastError)(0),                  // 18: live.v21.ProjectBroadcastError
	(ConnectState)(0),                           // 19: live.v21.ConnectState
	(EventSubType)(0),                           // 20: live.v21.EventSubType
	(EventType)(0),                              // 21: live.v21.EventType
	(*RateLimiter)(nil),                         // 22: live.v21.RateLimiter
	(*RateLimitConfig)(nil),                     // 23: live.v21.RateLimitConfig
	(*BroadcastOriginExternalMetadata)(nil),     // 24: live.v21.BroadcastOriginExternalMetadata
	(*BroadcastOriginSourceMetadata)(nil),       // 25: live.v21.BroadcastOriginSourceMetadata
	(*WebhookRequest)(nil),                      // 26: live.v21.WebhookRequest
	(*WebhookResponse)(nil),                     // 27: live.v21.WebhookResponse
	(*WebhookConfiguration)(nil),                // 28: live.v21.WebhookConfiguration
	(*AccountConfigurationHook)(nil),            // 29: live.v21.AccountConfigurationHook
	(*AccountConfiguration)(nil),                // 30: live.v21.AccountConfiguration
	(*GetAccountConfigurationRequest)(nil),      // 31: live.v21.GetAccountConfigurationRequest
	(*GetAccountConfigurationResponse)(nil),     // 32: live.v21.GetAccountConfigurationResponse
	(*UpdateAccountConfigurationRequest)(nil),   // 33: live.v21.UpdateAccountConfigurationRequest
	(*UpdateAccountConfigurationResponse)(nil),  // 34: live.v21.UpdateAccountConfigurationResponse
	(*VideoRendering)(nil),                      // 35: live.v21.VideoRendering
	(*AudioRendering)(nil),                      // 36: live.v21.AudioRendering
	(*Rendering)(nil),                           // 37: live.v21.Rendering
	(*VideoCodecRateControl)(nil),               // 38: live.v21.VideoCodecRateControl
	(*VideoEncoding)(nil),                       // 39: live.v21.VideoEncoding
	(*AudioEncoding)(nil),                       // 40: live.v21.AudioEncoding
	(*Encoding)(nil),                            // 41: live.v21.Encoding
	(*SourceRtmpPushAddress)(nil),               // 42: live.v21.SourceRtmpPushAddress
	(*SrtPushAddress)(nil),                      // 43: live.v21.SrtPushAddress
	(*RtmpPullAddress)(nil),                     // 44: live.v21.RtmpPullAddress
	(*SrtPullAddress)(nil),                      // 45: live.v21.SrtPullAddress
	(*DynamicAddress)(nil),                      // 46: live.v21.DynamicAddress
	(*DirectRTMPAddress)(nil),                   // 47: live.v21.DirectRTMPAddress
	(*DirectSrtAddress)(nil),                    // 48: live.v21.DirectSrtAddress
	(*RuntimeSourceAddress)(nil),                // 49: live.v21.RuntimeSourceAddress
	(*SourceAddress)(nil),                       // 50: live.v21.SourceAddress
	(*DestinationRtmpPushAddress)(nil),          // 51: live.v21.DestinationRtmpPushAddress
	(*DestinationSrtPushAddress)(nil),           // 52: live.v21.DestinationSrtPushAddress
	(*DestinationAgoraPushAddress)(nil),         // 53: live.v21.DestinationAgoraPushAddress
	(*HlsLifecycleLive)(nil),                    // 54: live.v21.HlsLifecycleLive
	(*HlsLifecycleVod)(nil),                     // 55: live.v21.HlsLifecycleVod
	(*HlsLifecycle)(nil),                        // 56: live.v21.HlsLifecycle
	(*HlsPackaging)(nil),                        // 57: live.v21.HlsPackaging
	(*ObjectStoragePackaging)(nil),              // 58: live.v21.ObjectStoragePackaging
	(*PreviewWebRtcAddress)(nil),                // 59: live.v21.PreviewWebRtcAddress
	(*S3StorageAddress)(nil),                    // 60: live.v21.S3StorageAddress
	(*DestinationAddress)(nil),                  // 61: live.v21.DestinationAddress
	(*SourceTrigger)(nil),                       // 62: live.v21.SourceTrigger
	(*WebRtcTrigger)(nil),                       // 63: live.v21.WebRtcTrigger
	(*ProjectTrigger)(nil),                      // 64: live.v21.ProjectTrigger
	(*PreviewHlsPullAddress)(nil),               // 65: live.v21.PreviewHlsPullAddress
	(*PreviewAddress)(nil),                      // 66: live.v21.PreviewAddress
	(*StudioSdkComposition)(nil),                // 67: live.v21.StudioSdkComposition
	(*StudioRendererComposition)(nil),           // 68: live.v21.StudioRendererComposition
	(*SceneComposition)(nil),                    // 69: live.v21.SceneComposition
	(*ExternalComposition)(nil),                 // 70: live.v21.ExternalComposition
	(*Composition)(nil),                         // 71: live.v21.Composition
	(*HostedWebRtc)(nil),                        // 72: live.v21.HostedWebRtc
	(*WebRtc)(nil),                              // 73: live.v21.WebRtc
	(*WebRtcAccess)(nil),                        // 74: live.v21.WebRtcAccess
	(*LatLong)(nil),                             // 75: live.v21.LatLong
	(*DirectIngestUrl)(nil),                     // 76: live.v21.DirectIngestUrl
	(*ProjectBroadcastStatus)(nil),              // 77: live.v21.ProjectBroadcastStatus
	(*Source)(nil),                              // 78: live.v21.Source
	(*Destination)(nil),                         // 79: live.v21.Destination
	(*Project)(nil),                             // 80: live.v21.Project
	(*Collection)(nil),                          // 81: live.v21.Collection
	(*CreateCollectionRequest)(nil),             // 82: live.v21.CreateCollectionRequest
	(*CreateCollectionResponse)(nil),            // 83: live.v21.CreateCollectionResponse
	(*GetCollectionRequest)(nil),                // 84: live.v21.GetCollectionRequest
	(*GetCollectionResponse)(nil),               // 85: live.v21.GetCollectionResponse
	(*UpdateCollectionRequest)(nil),             // 86: live.v21.UpdateCollectionRequest
	(*UpdateCollectionResponse)(nil),            // 87: live.v21.UpdateCollectionResponse
	(*DeleteCollectionRequest)(nil),             // 88: live.v21.DeleteCollectionRequest
	(*DeleteCollectionResponse)(nil),            // 89: live.v21.DeleteCollectionResponse
	(*GetCollectionsRequest)(nil),               // 90: live.v21.GetCollectionsRequest
	(*GetCollectionsResponse)(nil),              // 91: live.v21.GetCollectionsResponse
	(*CreateProjectRequest)(nil),                // 92: live.v21.CreateProjectRequest
	(*CreateProjectResponse)(nil),               // 93: live.v21.CreateProjectResponse
	(*UpdateProjectRequest)(nil),                // 94: live.v21.UpdateProjectRequest
	(*UpdateProjectResponse)(nil),               // 95: live.v21.UpdateProjectResponse
	(*DeleteProjectRequest)(nil),                // 96: live.v21.DeleteProjectRequest
	(*DeleteProjectResponse)(nil),               // 97: live.v21.DeleteProjectResponse
	(*StartProjectBroadcastRequest)(nil),        // 98: live.v21.StartProjectBroadcastRequest
	(*StartProjectBroadcastResponse)(nil),       // 99: live.v21.StartProjectBroadcastResponse
	(*StopProjectBroadcastRequest)(nil),         // 100: live.v21.StopProjectBroadcastRequest
	(*StopProjectBroadcastResponse)(nil),        // 101: live.v21.StopProjectBroadcastResponse
	(*GetProjectRequest)(nil),                   // 102: live.v21.GetProjectRequest
	(*GetProjectResponse)(nil),                  // 103: live.v21.GetProjectResponse
	(*GetProjectBroadcastSnapshotRequest)(nil),  // 104: live.v21.GetProjectBroadcastSnapshotRequest
	(*GetProjectBroadcastSnapshotResponse)(nil), // 105: live.v21.GetProjectBroadcastSnapshotResponse
	(*GetProjectBroadcastStatusRequest)(nil),    // 106: live.v21.GetProjectBroadcastStatusRequest
	(*GetProjectBroadcastStatusResponse)(nil),   // 107: live.v21.GetProjectBroadcastStatusResponse
	(*StartProjectWebRtcRequest)(nil),           // 108: live.v21.StartProjectWebRtcRequest
	(*StartProjectWebRtcResponse)(nil),          // 109: live.v21.StartProjectWebRtcResponse
	(*StopProjectWebRtcRequest)(nil),            // 110: live.v21.StopProjectWebRtcRequest
	(*StopProjectWebRtcResponse)(nil),           // 111: live.v21.StopProjectWebRtcResponse
	(*CreateDestinationRequest)(nil),            // 112: live.v21.CreateDestinationRequest
	(*CreateDestinationResponse)(nil),           // 113: live.v21.CreateDestinationResponse
	(*GetDestinationRequest)(nil),               // 114: live.v21.GetDestinationRequest
	(*GetDestinationResponse)(nil),              // 115: live.v21.GetDestinationResponse
	(*DeleteDestinationRequest)(nil),            // 116: live.v21.DeleteDestinationRequest
	(*DeleteDestinationResponse)(nil),           // 117: live.v21.DeleteDestinationResponse
	(*UpdateDestinationRequest)(nil),            // 118: live.v21.UpdateDestinationRequest
	(*UpdateDestinationResponse)(nil),           // 119: live.v21.UpdateDestinationResponse
	(*CreateSourceRequest)(nil),                 // 120: live.v21.CreateSourceRequest
	(*CreateSourceResponse)(nil),                // 121: live.v21.CreateSourceResponse
	(*DeleteSourceRequest)(nil),                 // 122: live.v21.DeleteSourceRequest
	(*DeleteSourceResponse)(nil),                // 123: live.v21.DeleteSourceResponse
	(*AddSourceToProjectRequest)(nil),           // 124: live.v21.AddSourceToProjectRequest
	(*AddSourceToProjectResponse)(nil),          // 125: live.v21.AddSourceToProjectResponse
	(*UpdateSourceInProjectRequest)(nil),        // 126: live.v21.UpdateSourceInProjectRequest
	(*UpdateSourceInProjectResponse)(nil),       // 127: live.v21.UpdateSourceInProjectResponse
	(*GetSourceRequest)(nil),                    // 128: live.v21.GetSourceRequest
	(*GetSourceResponse)(nil),                   // 129: live.v21.GetSourceResponse
	(*GetSourcesRequest)(nil),                   // 130: live.v21.GetSourcesRequest
	(*GetSourcesResponse)(nil),                  // 131: live.v21.GetSourcesResponse
	(*UpdateSourceRequest)(nil),                 // 132: live.v21.UpdateSourceRequest
	(*UpdateSourceResponse)(nil),                // 133: live.v21.UpdateSourceResponse
	(*RemoveSourceFromProjectRequest)(nil),      // 134: live.v21.RemoveSourceFromProjectRequest
	(*RemoveSourceFromProjectResponse)(nil),     // 135: live.v21.RemoveSourceFromProjectResponse
	(*GetSourcePlaylistRequest)(nil),            // 136: live.v21.GetSourcePlaylistRequest
	(*GetSourcePlaylistResponse)(nil),           // 137: live.v21.GetSourcePlaylistResponse
	(*CreateAccessTokenRequest)(nil),            // 138: live.v21.CreateAccessTokenRequest
	(*CreateAccessTokenResponse)(nil),           // 139: live.v21.CreateAccessTokenResponse
	(*LookupGuestCodeRequest)(nil),              // 140: live.v21.LookupGuestCodeRequest
	(*LookupGuestCodeResponse)(nil),             // 141: live.v21.LookupGuestCodeResponse
	(*GuestAccessTokenDirect)(nil),              // 142: live.v21.GuestAccessTokenDirect
	(*GuestAccessTokenExchange)(nil),            // 143: live.v21.GuestAccessTokenExchange
	(*GuestAccessToken)(nil),                    // 144: live.v21.GuestAccessToken
	(*CreateGuestAccessTokenRequest)(nil),       // 145: live.v21.CreateGuestAccessTokenRequest
	(*CreateGuestAccessTokenResponse)(nil),      // 146: live.v21.CreateGuestAccessTokenResponse
	(*CreateWebRtcAccessTokenRequest)(nil),      // 147: live.v21.CreateWebRtcAccessTokenRequest
	(*CreateWebRtcAccessTokenResponse)(nil),     // 148: live.v21.CreateWebRtcAccessTokenResponse
	(*RefreshAccessTokenRequest)(nil),           // 149: live.v21.RefreshAccessTokenRequest
	(*RefreshAccessTokenResponse)(nil),          // 150: live.v21.RefreshAccessTokenResponse
	(*GuestCodeRedirectRequest)(nil),            // 151: live.v21.GuestCodeRedirectRequest
	(*GuestCodeRedirectResponse)(nil),           // 152: live.v21.GuestCodeRedirectResponse
	(*IssuedGuestCode)(nil),                     // 153: live.v21.IssuedGuestCode
	(*CreateGuestCodeRequest)(nil),              // 154: live.v21.CreateGuestCodeRequest
	(*CreateGuestCodeResponse)(nil),             // 155: live.v21.CreateGuestCodeResponse
	(*GetGuestCodeRequest)(nil),                 // 156: live.v21.GetGuestCodeRequest
	(*GetGuestCodeResponse)(nil),                // 157: live.v21.GetGuestCodeResponse
	(*GetGuestCodesRequest)(nil),                // 158: live.v21.GetGuestCodesRequest
	(*GetGuestCodesResponse)(nil),               // 159: live.v21.GetGuestCodesResponse
	(*DeleteGuestCodeRequest)(nil),              // 160: live.v21.DeleteGuestCodeRequest
	(*DeleteGuestCodeResponse)(nil),             // 161: live.v21.DeleteGuestCodeResponse
	(*JsonWebKey)(nil),                          // 162: live.v21.JsonWebKey
	(*GetJsonWebKeySetRequest)(nil),             // 163: live.v21.GetJsonWebKeySetRequest
	(*GetJsonWebKeySetResponse)(nil),            // 164: live.v21.GetJsonWebKeySetResponse
	(*GetTestTokenRequest)(nil),                 // 165: live.v21.GetTestTokenRequest
	(*GetTestTokenResponse)(nil),                // 166: live.v21.GetTestTokenResponse
	(*DestinationCreateEvent)(nil),              // 167: live.v21.DestinationCreateEvent
	(*DestinationDeleteEvent)(nil),              // 168: live.v21.DestinationDeleteEvent
	(*DestinationUpdateEvent)(nil),              // 169: live.v21.DestinationUpdateEvent
	(*DestinationStateEvent)(nil),               // 170: live.v21.DestinationStateEvent
	(*ProjectCreateEvent)(nil),                  // 171: live.v21.ProjectCreateEvent
	(*ProjectDeleteEvent)(nil),                  // 172: live.v21.ProjectDeleteEvent
	(*ProjectUpdateEvent)(nil),                  // 173: live.v21.ProjectUpdateEvent
	(*ProjectBroadcastStateEvent)(nil),          // 174: live.v21.ProjectBroadcastStateEvent
	(*CollectionCreateEvent)(nil),               // 175: live.v21.CollectionCreateEvent
	(*CollectionDeleteEvent)(nil),               // 176: live.v21.CollectionDeleteEvent
	(*CollectionUpdateEvent)(nil),               // 177: live.v21.CollectionUpdateEvent
	(*SourceCreateEvent)(nil),                   // 178: live.v21.SourceCreateEvent
	(*SourceDeleteEvent)(nil),                   // 179: live.v21.SourceDeleteEvent
	(*SourceUpdateEvent)(nil),                   // 180: live.v21.SourceUpdateEvent
	(*SourceAddEvent)(nil),                      // 181: live.v21.SourceAddEvent
	(*SourceRemoveEvent)(nil),                   // 182: live.v21.SourceRemoveEvent
	(*SourceStateEvent)(nil),                    // 183: live.v21.SourceStateEvent
	(*CollectionEvent)(nil),                     // 184: live.v21.CollectionEvent
	(*DestinationEvent)(nil),                    // 185: live.v21.DestinationEvent
	(*ProjectEvent)(nil),                        // 186: live.v21.ProjectEvent
	(*SourceEvent)(nil),                         // 187: live.v21.SourceEvent
	(*LiveEvent)(nil),                           // 188: live.v21.LiveEvent
	(*GetServiceRequest)(nil),                   // 189: live.v21.GetServiceRequest
	(*Service)(nil),                             // 190: live.v21.Service
	(*GetServiceResponse)(nil),                  // 191: live.v21.GetServiceResponse
	nil,                                         // 192: live.v21.StartProjectBroadcastRequest.DynamicSourcesEntry
	...
	(structpb.NullValue)(0),                     // 196: google.protobuf.NullValue
	(*descriptorpb.MethodOptions)(nil),          // 197: google.protobuf.MethodOptions
	(*httpbody.HttpBody)(nil),                   // 198: google.api.HttpBody
}
var file_live_v21_api_proto_depIdxs = []int32{
	0,   // 0: live.v21.RateLimiter.target:type_name -> live.v21.RateLimiterType
	1,   // 1: live.v21.RateLimiter.bucket:type_name -> live.v21.RateLimiterBucket
	22,  // 2: live.v21.RateLimitConfig.limits:type_name -> live.v21.RateLimiter
	193, // 3: live.v21.BroadcastOriginExternalMetadata.value:type_name -> google.protobuf.Value
	2,   // 4: live.v21.WebhookRequest.broadcast_origin:type_name -> live.v21.BroadcastOrigin
	193, // 5: live.v21.WebhookRequest.broadcast_origin_api_metadata:type_name -> google.protobuf.Value
	25,  // 6: live.v21.WebhookRequest.broadcast_origin_source_metadata:type_name -> live.v21.BroadcastOriginSourceMetadata
	24,  // 7: live.v21.WebhookRequest.broadcast_origin_external_metadata:type_name -> live.v21.BroadcastOriginExternalMetadata
	28,  // 8: live.v21.AccountConfigurationHook.start_broadcast:type_name -> live.v21.WebhookConfiguration
	28,  // 9: live.v21.AccountConfigurationHook.start_webrtc:type_name -> live.v21.WebhookConfiguration
	28,  // 10: live.v21.AccountConfigurationHook.join_webrtc:type_name -> live.v21.WebhookConfiguration
	29,  // 11: live.v21.AccountConfiguration.hooks:type_name -> live.v21.AccountConfigurationHook
	30,  // 12: live.v21.GetAccountConfigurationResponse.account_configuration:type_name -> live.v21.AccountConfiguration
	29,  // 13: live.v21.UpdateAccountConfigurationRequest.hooks:type_name -> live.v21.AccountConfigurationHook
	194, // 14: live.v21.UpdateAccountConfigurationRequest.update_mask:type_name -> google.protobuf.FieldMask
	30,  // 15: live.v21.UpdateAccountConfigurationResponse.account_configuration:type_name -> live.v21.AccountConfiguration
	6,   // 16: live.v21.VideoRendering.color_space:type_name -> live.v21.VideoColorSpace
	7,   // 17: live.v21.AudioRendering.channel_layout:type_name -> live.v21.AudioChannelLayout
	35,  // 18: live.v21.Rendering.video:type_name -> live.v21.VideoRendering
	36,  // 19: live.v21.Rendering.audio:type_name -> live.v21.AudioRendering
	8,   // 20: live.v21.Rendering.quality:type_name -> live.v21.RenderingQuality
	12,  // 21: live.v21.VideoCodecRateControl.mode:type_name -> live.v21.VideoCodecRateControlMode
	9,   // 22: live.v21.VideoEncoding.codec:type_name -> live.v21.VideoCodec
	38,  // 23: live.v21.VideoEncoding.rate_control:type_name -> live.v21.VideoCodecRateControl
	10,  // 24: live.v21.VideoEncoding.profile:type_name -> live.v21.VideoCodecProfile
	11,  // 25: live.v21.AudioEncoding.codec:type_name -> live.v21.AudioCodec
	39,  // 26: live.v21.Encoding.video:type_name -> live.v21.VideoEncoding
	40,  // 27: live.v21.Encoding.audio:type_name -> live.v21.AudioEncoding
	44,  // 28: live.v21.RuntimeSourceAddress.rtmp_pull:type_name -> live.v21.RtmpPullAddress
	45,  // 29: live.v21.RuntimeSourceAddress.srt_pull:type_name -> live.v21.SrtPullAddress
	47,  // 30: live.v21.RuntimeSourceAddress.direct_rtmp_push:type_name -> live.v21.DirectRTMPAddress
	48,  // 31: live.v21.RuntimeSourceAddress.direct_srt_push:type_name -> live.v21.DirectSrtAddress
	42,  // 32: live.v21.SourceAddress.rtmp_push:type_name -> live.v21.SourceRtmpPushAddress
	43,  // 33: live.v21.SourceAddress.srt_push:type_name -> live.v21.SrtPushAddress
	44,  // 34: live.v21.SourceAddress.rtmp_pull:type_name -> live.v21.RtmpPullAddress
	45,  // 35: live.v21.SourceAddress.srt_pull:type_name -> live.v21.SrtPullAddress
	46,  // 36: live.v21.SourceAddress.dynamic:type_name -> live.v21.DynamicAddress
	55,  // 37: live.v21.HlsLifecycle.vod:type_name -> live.v21.HlsLifecycleVod
	54,  // 38: live.v21.HlsLifecycle.live:type_name -> live.v21.HlsLifecycleLive
	56,  // 39: live.v21.HlsPackaging.lifecycle:type_name -> live.v21.HlsLifecycle
	57,  // 40: live.v21.ObjectStoragePackaging.hls:type_name -> live.v21.HlsPackaging
	14,  // 41: live.v21.S3StorageAddress.acl:type_name -> live.v21.S3ACL
	58,  // 42: live.v21.S3StorageAddress.packaging:type_name -> live.v21.ObjectStoragePackaging
	51,  // 43: live.v21.DestinationAddress.rtmp_push:type_name -> live.v21.DestinationRtmpPushAddress
	53,  // 44: live.v21.DestinationAddress.agora:type_name -> live.v21.DestinationAgoraPushAddress
	60,  // 45: live.v21.DestinationAddress.s3_storage:type_name -> live.v21.S3StorageAddress
	52,  // 46: live.v21.DestinationAddress.srt_push:type_name -> live.v21.DestinationSrtPushAddress
	59,  // 47: live.v21.DestinationAddress.webrtc_preview:type_name -> live.v21.PreviewWebRtcAddress
	15,  // 48: live.v21.SourceTrigger.start:type_name -> live.v21.SourceTriggerAction
	15,  // 49: live.v21.SourceTrigger.stop:type_name -> live.v21.SourceTriggerAction
	15,  // 50: live.v21.WebRtcTrigger.stop:type_name -> live.v21.SourceTriggerAction
	62,  // 51: live.v21.ProjectTrigger.source:type_name -> live.v21.SourceTrigger
	59,  // 52: live.v21.PreviewAddress.webrtc:type_name -> live.v21.PreviewWebRtcAddress
	70,  // 53: live.v21.Composition.external:type_name -> live.v21.ExternalComposition
	67,  // 54: live.v21.Composition.studio_sdk:type_name -> live.v21.StudioSdkComposition
	68,  // 55: live.v21.Composition.studio_renderer:type_name -> live.v21.StudioRendererComposition
	69,  // 56: live.v21.Composition.scene:type_name -> live.v21.SceneComposition
	72,  // 57: live.v21.WebRtc.hosted:type_name -> live.v21.HostedWebRtc
	42,  // 58: live.v21.DirectIngestUrl.rtmp_push:type_name -> live.v21.SourceRtmpPushAddress
	43,  // 59: live.v21.DirectIngestUrl.srt_push:type_name -> live.v21.SrtPushAddress
	195, // 60: live.v21.ProjectBroadcastStatus.start:type_name -> google.protobuf.Timestamp
	195, // 61: live.v21.ProjectBroadcastStatus.stop:type_name -> google.protobuf.Timestamp
	13,  // 62: live.v21.ProjectBroadcastStatus.phase:type_name -> live.v21.ProjectBroadcastPhase
	16,  // 63: live.v21.ProjectBroadcastStatus.region:type_name -> live.v21.Region
	76,  // 64: live.v21.ProjectBroadcastStatus.direct_ingests:type_name -> live.v21.DirectIngestUrl
	2,   // 65: live.v21.ProjectBroadcastStatus.origin:type_name -> live.v21.BroadcastOrigin
	193, // 66: live.v21.ProjectBroadcastStatus.origin_api_metadata:type_name -> google.protobuf.Value
	25,  // 67: live.v21.ProjectBroadcastStatus.origin_source_metadata:type_name -> live.v21.BroadcastOriginSourceMetadata
	24,  // 68: live.v21.ProjectBroadcastStatus.origin_external_metadata:type_name -> live.v21.BroadcastOriginExternalMetadata
	193, // 69: live.v21.Source.metadata:type_name -> google.protobuf.Value
	66,  // 70: live.v21.Source.preview:type_name -> live.v21.PreviewAddress
	50,  // 71: live.v21.Source.address:type_name -> live.v21.SourceAddress
	193, // 72: live.v21.Destination.metadata:type_name -> google.protobuf.Value
	61,  // 73: live.v21.Destination.address:type_name -> live.v21.DestinationAddress
	193, // 74: live.v21.Project.metadata:type_name -> google.protobuf.Value
	37,  // 75: live.v21.Project.rendering:type_name -> live.v21.Rendering
	41,  // 76: live.v21.Project.encoding:type_name -> live.v21.Encoding
	78,  // 77: live.v21.Project.sources:type_name -> live.v21.Source
	79,  // 78: live.v21.Project.destinations:type_name -> live.v21.Destination
	71,  // 79: live.v21.Project.composition:type_name -> live.v21.Composition
	73,  // 80: live.v21.Project.webrtc:type_name -> live.v21.WebRtc
	64,  // 81: live.v21.Project.triggers:type_name -> live.v21.ProjectTrigger
	75,  // 82: live.v21.Project.location:type_name -> live.v21.LatLong
	193, // 83: live.v21.Collection.metadata:type_name -> google.protobuf.Value
	80,  // 84: live.v21.Collection.projects:type_name -> live.v21.Project
	78,  // 85: live.v21.Collection.sources:type_name -> live.v21.Source
	193, // 86: live.v21.CreateCollectionRequest.metadata:type_name -> google.protobuf.Value
	81,  // 87: live.v21.CreateCollectionResponse.collection:type_name -> live.v21.Collection
	81,  // 88: live.v21.GetCollectionResponse.collection:type_name -> live.v21.Collection
	194, // 89: live.v21.UpdateCollectionRequest.update_mask:type_name -> google.protobuf.FieldMask
	193, // 90: live.v21.UpdateCollectionRequest.metadata:type_name -> google.protobuf.Value
	81,  // 91: live.v21.UpdateCollectionResponse.collection:type_name -> live.v21.Collection
	81,  // 92: live.v21.GetCollectionsResponse.collections:type_name -> live.v21.Collection
	193, // 93: live.v21.CreateProjectRequest.metadata:type_name -> google.protobuf.Value
	37,  // 94: live.v21.CreateProjectRequest.rendering:type_name -> live.v21.Rendering
	41,  // 95: live.v21.CreateProjectRequest.encoding:type_name -> live.v21.Encoding
	71,  // 96: live.v21.CreateProjectRequest.composition:type_name -> live.v21.Composition
	73,  // 97: live.v21.CreateProjectRequest.webrtc:type_name -> live.v21.WebRtc
	75,  // 98: live.v21.CreateProjectRequest.location:type_name -> live.v21.LatLong
	80,  // 99: live.v21.CreateProjectResponse.project:type_name -> live.v21.Project
	194, // 100: live.v21.UpdateProjectRequest.update_mask:type_name -> google.protobuf.FieldMask
	193, // 101: live.v21.UpdateProjectRequest.metadata:type_name -> google.protobuf.Value
	37,  // 102: live.v21.UpdateProjectRequest.rendering:type_name -> live.v21.Rendering
	41,  // 103: live.v21.UpdateProjectRequest.encoding:type_name -> live.v21.Encoding
	71,  // 104: live.v21.UpdateProjectRequest.composition:type_name -> live.v21.Composition
	73,  // 105: live.v21.UpdateProjectRequest.webrtc:type_name -> live.v21.WebRtc
	75,  // 106: live.v21.UpdateProjectRequest.location:type_name -> live.v21.LatLong
	80,  // 107: live.v21.UpdateProjectResponse.project:type_name -> live.v21.Project
	192, // 108: live.v21.StartProjectBroadcastRequest.dynamic_sources:type_name -> live.v21.StartProjectBroadcastRequest.DynamicSourcesEntry
	193, // 109: live.v21.StartProjectBroadcastRequest.request_metadata:type_name -> google.protobuf.Value
	80,  // 110: live.v21.GetProjectResponse.project:type_name -> live.v21.Project
	77,  // 111: live.v21.GetProjectResponse.status:type_name -> live.v21.ProjectBroadcastStatus
	5,   // 112: live.v21.GetProjectBroadcastSnapshotRequest.format:type_name -> live.v21.ImageFormat
	5,   // 113: live.v21.GetProjectBroadcastSnapshotResponse.format:type_name -> live.v21.ImageFormat
	77,  // 114: live.v21.GetProjectBroadcastStatusResponse.status:type_name -> live.v21.ProjectBroadcastStatus
	193, // 115: live.v21.CreateDestinationRequest.metadata:type_name -> google.protobuf.Value
	61,  // 116: live.v21.CreateDestinationRequest.address:type_name -> live.v21.DestinationAddress
	79,  // 117: live.v21.CreateDestinationResponse.destination:type_name -> live.v21.Destination
	79,  // 118: live.v21.GetDestinationResponse.destination:type_name -> live.v21.Destination
	194, // 119: live.v21.UpdateDestinationRequest.update_mask:type_name -> google.protobuf.FieldMask
	193, // 120: live.v21.UpdateDestinationRequest.metadata:type_name -> google.protobuf.Value
	61,  // 121: live.v21.UpdateDestinationRequest.address:type_name -> live.v21.DestinationAddress
	79,  // 122: live.v21.UpdateDestinationResponse.destination:type_name -> live.v21.Destination
	193, // 123: live.v21.CreateSourceRequest.metadata:type_name -> google.protobuf.Value
	50,  // 124: live.v21.CreateSourceRequest.address:type_name -> live.v21.SourceAddress
	66,  // 125: live.v21.CreateSourceRequest.preview:type_name -> live.v21.PreviewAddress
	78,  // 126: live.v21.CreateSourceResponse.source:type_name -> live.v21.Source
	62,  // 127: live.v21.AddSourceToProjectRequest.trigger:type_name -> live.v21.SourceTrigger
	80,  // 128: live.v21.AddSourceToProjectResponse.project:type_name -> live.v21.Project
	194, // 129: live.v21.UpdateSourceInProjectRequest.update_mask:type_name -> google.protobuf.FieldMask
	62,  // 130: live.v21.UpdateSourceInProjectRequest.trigger:type_name -> live.v21.SourceTrigger
	80,  // 131: live.v21.UpdateSourceInProjectResponse.project:type_name -> live.v21.Project
	78,  // 132: live.v21.GetSourceResponse.source:type_name -> live.v21.Source
	78,  // 133: live.v21.GetSourcesResponse.sources:type_name -> live.v21.Source
	194, // 134: live.v21.UpdateSourceRequest.update_mask:type_name -> google.protobuf.FieldMask
	193, // 135: live.v21.UpdateSourceRequest.metadata:type_name -> google.protobuf.Value
	50,  // 136: live.v21.UpdateSourceRequest.address:type_name -> live.v21.SourceAddress
	66,  // 137: live.v21.UpdateSourceRequest.preview:type_name -> live.v21.PreviewAddress
	78,  // 138: live.v21.UpdateSourceResponse.source:type_name -> live.v21.Source
	80,  // 139: live.v21.RemoveSourceFromProjectResponse.project:type_name -> live.v21.Project
	17,  // 140: live.v21.CreateAccessTokenRequest.role:type_name -> live.v21.Role
	142, // 141: live.v21.GuestAccessToken.direct:type_name -> live.v21.GuestAccessTokenDirect
	143, // 142: live.v21.GuestAccessToken.exchange:type_name -> live.v21.GuestAccessTokenExchange
	17,  // 143: live.v21.CreateGuestAccessTokenRequest.role:type_name -> live.v21.Role
	144, // 144: live.v21.CreateGuestAccessTokenRequest.token:type_name -> live.v21.GuestAccessToken
	193, // 145: live.v21.CreateWebRtcAccessTokenRequest.participant_metadata:type_name -> google.protobuf.Value
	74,  // 146: live.v21.CreateWebRtcAccessTokenResponse.webrtc_access:type_name -> live.v21.WebRtcAccess
	17,  // 147: live.v21.IssuedGuestCode.role:type_name -> live.v21.Role
	144, // 148: live.v21.IssuedGuestCode.token:type_name -> live.v21.GuestAccessToken
	17,  // 149: live.v21.CreateGuestCodeRequest.role:type_name -> live.v21.Role
	144, // 150: live.v21.CreateGuestCodeRequest.token:type_name -> live.v21.GuestAccessToken
	153, // 151: live.v21.CreateGuestCodeResponse.guest_code:type_name -> live.v21.IssuedGuestCode
	153, // 152: live.v21.GetGuestCodeResponse.guest_code:type_name -> live.v21.IssuedGuestCode
	17,  // 153: live.v21.GetGuestCodesRequest.role:type_name -> live.v21.Role
	153, // 154: live.v21.GetGuestCodesResponse.guest_codes:type_name -> live.v21.IssuedGuestCode
	162, // 155: live.v21.GetJsonWebKeySetResponse.keys:type_name -> live.v21.JsonWebKey
	79,  // 156: live.v21.DestinationCreateEvent.destination:type_name -> live.v21.Destination
	79,  // 157: live.v21.DestinationUpdateEvent.destination:type_name -> live.v21.Destination
	19,  // 158: live.v21.DestinationStateEvent.connect:type_name -> live.v21.ConnectState
	80,  // 159: live.v21.ProjectCreateEvent.project:type_name -> live.v21.Project
	80,  // 160: live.v21.ProjectUpdateEvent.project:type_name -> live.v21.Project
	13,  // 161: live.v21.ProjectBroadcastStateEvent.phase:type_name -> live.v21.ProjectBroadcastPhase
	18,  // 162: live.v21.ProjectBroadcastStateEvent.error:type_name -> live.v21.ProjectBroadcastError
	81,  // 163: live.v21.CollectionCreateEvent.collection:type_name -> live.v21.Collection
	81,  // 164: live.v21.CollectionUpdateEvent.collection:type_name -> live.v21.Collection
	78,  // 165: live.v21.SourceCreateEvent.source:type_name -> live.v21.Source
	78,  // 166: live.v21.SourceUpdateEvent.source:type_name -> live.v21.Source
	78,  // 167: live.v21.SourceAddEvent.source:type_name -> live.v21.Source
	19,  // 168: live.v21.SourceStateEvent.connect:type_name -> live.v21.ConnectState
	175, // 169: live.v21.CollectionEvent.create:type_name -> live.v21.CollectionCreateEvent
	177, // 170: live.v21.CollectionEvent.update:type_name -> live.v21.CollectionUpdateEvent
	176, // 171: live.v21.CollectionEvent.delete:type_name -> live.v21.CollectionDeleteEvent
	167, // 172: live.v21.DestinationEvent.create:type_name -> live.v21.DestinationCreateEvent
	169, // 173: live.v21.DestinationEvent.update:type_name -> live.v21.DestinationUpdateEvent
	168, // 174: live.v21.DestinationEvent.delete:type_name -> live.v21.DestinationDeleteEvent
	170, // 175: live.v21.DestinationEvent.state:type_name -> live.v21.DestinationStateEvent
	171, // 176: live.v21.ProjectEvent.create:type_name -> live.v21.ProjectCreateEvent
	173, // 177: live.v21.ProjectEvent.update:type_name -> live.v21.ProjectUpdateEvent
	172, // 178: live.v21.ProjectEvent.delete:type_name -> live.v21.ProjectDeleteEvent
	174, // 179: live.v21.ProjectEvent.state:type_name -> live.v21.ProjectBroadcastStateEvent
	178, // 180: live.v21.SourceEvent.create:type_name -> live.v21.SourceCreateEvent
	180, // 181: live.v21.SourceEvent.update:type_name -> live.v21.SourceUpdateEvent
	179, // 182: live.v21.SourceEvent.delete:type_name -> live.v21.SourceDeleteEvent
	181, // 183: live.v21.SourceEvent.add:type_name -> live.v21.SourceAddEvent
	182, // 184: live.v21.SourceEvent.remove:type_name -> live.v21.SourceRemoveEvent
	183, // 185: live.v21.SourceEvent.state:type_name -> live.v21.SourceStateEvent
	184, // 186: live.v21.LiveEvent.collection:type_name -> live.v21.CollectionEvent
	185, // 187: live.v21.LiveEvent.destination:type_name -> live.v21.DestinationEvent
	186, // 188: live.v21.LiveEvent.project:type_name -> live.v21.ProjectEvent
	187, // 189: live.v21.LiveEvent.source:type_name -> live.v21.SourceEvent
	196, // 190: live.v21.LiveEvent.unspecified:type_name -> google.protobuf.NullValue
	190, // 191: live.v21.GetServiceResponse.service:type_name -> live.v21.Service
	49,  // 192: live.v21.StartProjectBroadcastRequest.DynamicSourcesEntry.value:type_name -> live.v21.RuntimeSourceAddress
	197, // 193: live.v21.rate_limit:extendee -> google.protobuf.MethodOptions
	23,  // 194: live.v21.rate_limit:type_name -> live.v21.RateLimitConfig
	31,  // 195: live.v21.AccountConfigurationService.GetAccountConfiguration:input_type -> live.v21.GetAccountConfigurationRequest
	33,  // 196: live.v21.AccountConfigurationService.UpdateAccountConfiguration:input_type -> live.v21.UpdateAccountConfigurationRequest
	82,  // 197: live.v21.CollectionService.CreateCollection:input_type -> live.v21.CreateCollectionRequest
	84,  // 198: live.v21.CollectionService.GetCollection:input_type -> live.v21.GetCollectionRequest
	90,  // 199: live.v21.CollectionService.GetCollections:input_type -> live.v21.GetCollectionsRequest
	86,  // 200: live.v21.CollectionService.UpdateCollection:input_type -> live.v21.UpdateCollectionRequest
	88,  // 201: live.v21.CollectionService.DeleteCollection:input_type -> live.v21.DeleteCollectionRequest
	92,  // 202: live.v21.ProjectService.CreateProject:input_type -> live.v21.CreateProjectRequest
	102, // 203: live.v21.ProjectService.GetProject:input_type -> live.v21.GetProjectRequest
	96,  // 204: live.v21.ProjectService.DeleteProject:input_type -> live.v21.DeleteProjectRequest
	94,  // 205: live.v21.ProjectService.UpdateProject:input_type -> live.v21.UpdateProjectRequest
	98,  // 206: live.v21.ProjectService.StartProjectBroadcast:input_type -> live.v21.StartProjectBroadcastRequest
	100, // 207: live.v21.ProjectService.StopProjectBroadcast:input_type -> live.v21.StopProjectBroadcastRequest
	108, // 208: live.v21.ProjectService.StartProjectWebRtc:input_type -> live.v21.StartProjectWebRtcRequest
	110, // 209: live.v21.ProjectService.StopProjectWebRtc:input_type -> live.v21.StopProjectWebRtcRequest
	104, // 210: live.v21.ProjectService.GetProjectBroadcastSnapshot:input_type -> live.v21.GetProjectBroadcastSnapshotRequest
	106, // 211: live.v21.ProjectService.GetProjectBroadcastStatus:input_type -> live.v21.GetProjectBroadcastStatusRequest
	112, // 212: live.v21.DestinationService.CreateDestination:input_type -> live.v21.CreateDestinationRequest
	114, // 213: live.v21.DestinationService.GetDestination:input_type -> live.v21.GetDestinationRequest
	118, // 214: live.v21.DestinationService.UpdateDestination:input_type -> live.v21.UpdateDestinationRequest
	116, // 215: live.v21.DestinationService.DeleteDestination:input_type -> live.v21.DeleteDestinationRequest
	120, // 216: live.v21.SourceService.CreateSource:input_type -> live.v21.CreateSourceRequest
	122, // 217: live.v21.SourceService.DeleteSource:input_type -> live.v21.DeleteSourceRequest
	132, // 218: live.v21.SourceService.UpdateSource:input_type -> live.v21.UpdateSourceRequest
	126, // 219: live.v21.SourceService.UpdateSourceInProject:input_type -> live.v21.UpdateSourceInProjectRequest
	128, // 220: live.v21.SourceService.GetSource:input_type -> live.v21.GetSourceRequest
	130, // 221: live.v21.SourceService.GetSources:input_type -> live.v21.GetSourcesRequest
	124, // 222: live.v21.SourceService.AddSourceToProject:input_type -> live.v21.AddSourceToProjectRequest
	134, // 223: live.v21.SourceService.RemoveSourceFromProject:input_type -> live.v21.RemoveSourceFromProjectRequest
	136, // 224: live.v21.SourceService.GetSourcePlaylist:input_type -> live.v21.GetSourcePlaylistRequest
	138, // 225: live.v21.BackendAuthenticationService.CreateAccessToken:input_type -> live.v21.CreateAccessTokenRequest
	140, // 226: live.v21.BackendAuthenticationService.LookupGuestCode:input_type -> live.v21.LookupGuestCodeRequest
	145, // 227: live.v21.AuthenticationService.CreateGuestAccessToken:input_type -> live.v21.CreateGuestAccessTokenRequest
	149, // 228: live.v21.AuthenticationService.RefreshAccessToken:input_type -> live.v21.RefreshAccessTokenRequest
	147, // 229: live.v21.AuthenticationService.CreateWebRtcAccessToken:input_type -> live.v21.CreateWebRtcAccessTokenRequest
	154, // 230: live.v21.AuthenticationService.CreateGuestCode:input_type -> live.v21.CreateGuestCodeRequest
	156, // 231: live.v21.AuthenticationService.GetGuestCode:input_type -> live.v21.GetGuestCodeRequest
	158, // 232: live.v21.AuthenticationService.GetGuestCodes:input_type -> live.v21.GetGuestCodesRequest
	160, // 233: live.v21.AuthenticationService.DeleteGuestCode:input_type -> live.v21.DeleteGuestCodeRequest
	163, // 234: live.v21.PublicAuthenticationService.GetJsonWebKeySet:input_type -> live.v21.GetJsonWebKeySetRequest
	151, // 235: live.v21.PublicAuthenticationService.GuestCodeRedirect:input_type -> live.v21.GuestCodeRedirectRequest
	189, // 236: live.v21.AccountService.GetService:input_type -> live.v21.GetServiceRequest
	32,  // 237: live.v21.AccountConfigurationService.GetAccountConfiguration:output_type -> live.v21.GetAccountConfigurationResponse
	34,  // 238: live.v21.AccountConfigurationService.UpdateAccountConfiguration:output_type -> live.v21.UpdateAccountConfigurationResponse
	83,  // 239: live.v21.CollectionService.CreateCollection:output_type -> live.v21.CreateCollectionResponse
	85,  // 240: live.v21.CollectionService.GetCollection:output_type -> live.v21.GetCollectionResponse
	91,  // 241: live.v21.CollectionService.GetCollections:output_type -> live.v21.GetCollectionsResponse
	87,  // 242: live.v21.CollectionService.UpdateCollection:output_type -> live.v21.UpdateCollectionResponse
	89,  // 243: live.v21.CollectionService.DeleteCollection:output_type -> live.v21.DeleteCollectionResponse
	93,  // 244: live.v21.ProjectService.CreateProject:output_type -> live.v21.CreateProjectResponse
	103, // 245: live.v21.ProjectService.GetProject:output_type -> live.v21.GetProjectResponse
	97,  // 246: live.v21.ProjectService.DeleteProject:output_type -> live.v21.DeleteProjectResponse
	95,  // 247: live.v21.ProjectService.UpdateProject:output_type -> live.v21.UpdateProjectResponse
	99,  // 248: live.v21.ProjectService.StartProjectBroadcast:output_type -> live.v21.StartProjectBroadcastResponse
	101, // 249: live.v21.ProjectService.StopProjectBroadcast:output_type -> live.v21.StopProjectBroadcastResponse
	109, // 250: live.v21.ProjectService.StartProjectWebRtc:output_type -> live.v21.StartProjectWebRtcResponse
	111, // 251: live.v21.ProjectService.StopProjectWebRtc:output_type -> live.v21.StopProjectWebRtcResponse
	105, // 252: live.v21.ProjectService.GetProjectBroadcastSnapshot:output_type -> live.v21.GetProjectBroadcastSnapshotResponse
	107, // 253: live.v21.ProjectService.GetProjectBroadcastStatus:output_type -> live.v21.GetProjectBroadcastStatusResponse
	113, // 254: live.v21.DestinationService.CreateDestination:output_type -> live.v21.CreateDestinationResponse
	115, // 255: live.v21.DestinationService.GetDestination:output_type -> live.v21.GetDestinationResponse
	119, // 256: live.v21.DestinationService.UpdateDestination:output_type -> live.v21.UpdateDestinationResponse
	117, // 257: live.v21.DestinationService.DeleteDestination:output_type -> live.v21.DeleteDestinationResponse
	121, // 258: live.v21.SourceService.CreateSource:output_type -> live.v21.CreateSourceResponse
	123, // 259: live.v21.SourceService.DeleteSource:output_type -> live.v21.DeleteSourceResponse
	133, // 260: live.v21.SourceService.UpdateSource:output_type -> live.v21.UpdateSourceResponse
	127, // 261: live.v21.SourceService.UpdateSourceInProject:output_type -> live.v21.UpdateSourceInProjectResponse
	129, // 262: live.v21.SourceService.GetSource:output_type -> live.v21.GetSourceResponse
	131, // 263: live.v21.SourceService.GetSources:output_type -> live.v21.GetSourcesResponse
	125, // 264: live.v21.SourceService.AddSourceToProject:output_type -> live.v21.AddSourceToProjectResponse
	135, // 265: live.v21.SourceService.RemoveSourceFromProject:output_type -> live.v21.RemoveSourceFromProjectResponse
	198, // 266: live.v21.SourceService.GetSourcePlaylist:output_type -> google.api.HttpBody
	139, // 267: live.v21.BackendAuthenticationService.CreateAccessToken:output_type -> live.v21.CreateAccessTokenResponse
	141, // 268: live.v21.BackendAuthenticationService.LookupGuestCode:output_type -> live.v21.LookupGuestCodeResponse
	146, // 269: live.v21.AuthenticationService.CreateGuestAccessToken:output_type -> live.v21.CreateGuestAccessTokenResponse
	150, // 270: live.v21.AuthenticationService.RefreshAccessToken:output_type -> live.v21.RefreshAccessTokenResponse
	148, // 271: live.v21.AuthenticationService.CreateWebRtcAccessToken:output_type -> live.v21.CreateWebRtcAccessTokenResponse
	155, // 272: live.v21.AuthenticationService.CreateGuestCode:output_type -> live.v21.CreateGuestCodeResponse
	157, // 273: live.v21.AuthenticationService.GetGuestCode:output_type -> live.v21.GetGuestCodeResponse
	159, // 274: live.v21.AuthenticationService.GetGuestCodes:output_type -> live.v21.GetGuestCodesResponse
	161, // 275: live.v21.AuthenticationService.DeleteGuestCode:output_type -> live.v21.DeleteGuestCodeResponse
	164, // 276: live.v21.PublicAuthenticationService.GetJsonWebKeySet:output_type -> live.v21.GetJsonWebKeySetResponse
	152, // 277: live.v21.PublicAuthenticationService.GuestCodeRedirect:output_type -> live.v21.GuestCodeRedirectResponse
	191, // 278: live.v21.AccountService.GetService:output_type -> live.v21.GetServiceResponse
	237, // [237:279] is the sub-list for method output_type
	195, // [195:237] is the sub-list for method input_type
	194, // [194:195] is the sub-list for extension type_name
	193, // [193:194] is the sub-list for extension extendee
...
func file_live_v21_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_live_v21_api_proto_msgTypes[168].Exporter = func(v interface{}, i int) interface{} {
		...
		file_live_v21_api_proto_msgTypes[169].Exporter = func(v interface{}, i int) interface{} {
	...
	file_live_v21_api_proto_msgTypes[7].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[8].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[20].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[21].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[28].OneofWrappers = []interface{}{
	...
	file_live_v21_api_proto_msgTypes[29].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[46].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[51].OneofWrappers = []interface{}{
		(*WebRtc_Hosted)(nil),
	}
	...
	file_live_v21_api_proto_msgTypes[59].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[66].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[81].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[82].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[90].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[104].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[116].OneofWrappers = []interface{}{}
	...
	file_live_v21_api_proto_msgTypes[123].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[124].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[131].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[132].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[136].OneofWrappers = []interface{}{}
	file_live_v21_api_proto_msgTypes[148].OneofWrappers = []interface{}{
		(*DestinationStateEvent_Connect)(nil),
	}
	file_live_v21_api_proto_msgTypes[152].OneofWrappers = []interface{}{
	...
	file_live_v21_api_proto_msgTypes[165].OneofWrappers = []interface{}{
	...
	file_live_v21_api_proto_msgTypes[166].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		...
		ExtensionInfos:    file_live_v21_api_proto_extTypes,
	}.Build()
